...
Training parameters can be overridden with environment variables:
  ...
  CNN_MAX_EPOCHS                        default: 30
  CNN_PATIENCE                          default: 8
  CNN_LEARNING_RATE                     default: 1e-5
  CNN_WEIGHT_DECAY                      default: 1e-4
  PHOWHISPER_FROZEN_BATCH_SIZE          default: 16
  PHOWHISPER_FROZEN_MAX_EPOCHS          default: 30
  PHOWHISPER_FROZEN_PATIENCE            default: 5
  PHOWHISPER_FROZEN_LEARNING_RATE       default: 1e-5
  PHOWHISPER_FROZEN_WEIGHT_DECAY        default: 1e-4
  PHOWHISPER_FINE_TUNE_BATCH_SIZE       default: 16
  PHOWHISPER_FINE_TUNE_MAX_EPOCHS       default: 30
  PHOWHISPER_FINE_TUNE_PATIENCE         default: 3
  PHOWHISPER_FINE_TUNE_LEARNING_RATE    default: 1e-5
  PHOWHISPER_FINE_TUNE_WEIGHT_DECAY     default: 1e-4
...
CNN_MAX_EPOCHS="${CNN_MAX_EPOCHS:-30}"
CNN_PATIENCE="${CNN_PATIENCE:-15}"
CNN_LEARNING_RATE="${CNN_LEARNING_RATE:-1e-4}"
CNN_WEIGHT_DECAY="${CNN_WEIGHT_DECAY:-1e-5}"

PHOWHISPER_FROZEN_BATCH_SIZE="${PHOWHISPER_FROZEN_BATCH_SIZE:-16}"
PHOWHISPER_FROZEN_MAX_EPOCHS="${PHOWHISPER_FROZEN_MAX_EPOCHS:-30}"
PHOWHISPER_FROZEN_PATIENCE="${PHOWHISPER_FROZEN_PATIENCE:-15}"
PHOWHISPER_FROZEN_LEARNING_RATE="${PHOWHISPER_FROZEN_LEARNING_RATE:-1e-4}"
PHOWHISPER_FROZEN_WEIGHT_DECAY="${PHOWHISPER_FROZEN_WEIGHT_DECAY:-1e-5}"

PHOWHISPER_FINE_TUNE_BATCH_SIZE="${PHOWHISPER_FINE_TUNE_BATCH_SIZE:-16}"
PHOWHISPER_FINE_TUNE_MAX_EPOCHS="${PHOWHISPER_FINE_TUNE_MAX_EPOCHS:-30}"
PHOWHISPER_FINE_TUNE_PATIENCE="${PHOWHISPER_FINE_TUNE_PATIENCE:-15}"
PHOWHISPER_FINE_TUNE_LEARNING_RATE="${PHOWHISPER_FINE_TUNE_LEARNING_RATE:-1e-4}"
PHOWHISPER_FINE_TUNE_WEIGHT_DECAY="${PHOWHISPER_FINE_TUNE_WEIGHT_DECAY:-1e-5}"
